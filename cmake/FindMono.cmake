# Stolen from: https://github.com/sidch/CMake/blob/master/Modules/FindMono.cmake
# - Try to find the mono, mcs and gacutil
#
# Defines:
#
# MONO_FOUND             System has Mono dev files, as well as mono, mcs and gacutil if not MONO_ONLY_LIBRARIES_REQUIRED
...
# To avoid searching for the Mono executables (mono, mcs, gacutil), set MONO_ONLY_LIBRARIES_REQUIRED.
#
  ...
  ELSE(WIN32)  # Unix
    ...
    ELSE(NOT PKG_CONFIG_FOUND)
      ...
      IF(MONO_MINIMUM_VERSION)
        PKG_CHECK_MODULES(MONO REQUIRED mono-2 >= ${MONO_MINIMUM_VERSION})  # will set MONO_FOUND
      ELSE(MONO_MINIMUM_VERSION)
        PKG_CHECK_MODULES(MONO REQUIRED mono-2 REQUIRED)  # will set MONO_FOUND
...
ELSE(MONO_FOUND)
  IF(MONO_FIND_REQUIRED)
    ...
    ELSE(MONO_ONLY_LIBRARIES_REQUIRED)
      MESSAGE(FATAL_ERROR "Could not find one or more of the following: mono, mcs, gacutil, Mono development files")
    ENDIF(MONO_ONLY_LIBRARIES_REQUIRED)
  ENDIF(MONO_FIND_REQUIRED)
ENDIF(MONO_FOUND)

MARK_AS_ADVANCED(MONO_EXECUTABLE MCS_EXECUTABLE GACUTIL_EXECUTABLE MONO_PKG_CONFIG_PATH)
